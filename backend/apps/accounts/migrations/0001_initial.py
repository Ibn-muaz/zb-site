    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('login', 'Login'), ('logout', 'Logout'), ('view_property', 'Viewed Property'), ('save_property', 'Saved Property'), ('make_offer', 'Made Offer'), ('payment', 'Made Payment'), ('register', 'Registered')], max_length=30)),
